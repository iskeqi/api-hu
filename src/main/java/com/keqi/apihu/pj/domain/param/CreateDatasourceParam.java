...
@AllArgsConstructor
@NoArgsConstructor
public class CreateDatasourceParam {
     ...
     * 数据源连接url
     */
    @ApiModelProperty(value = "数据源连接url", example = "jdbc:mysql://10.10.20.200:3306/api-hu?useUnicode=true&characterEncoding=utf8", required = true)
    @NotBlank
    private String url;
